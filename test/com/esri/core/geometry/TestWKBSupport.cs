...
{
	public class TestWKBSupport : NUnit.Framework.TestCase
	{
		...
		public virtual void TestWKB2()
		{
			...
			com.esri.core.geometry.Geometry geom = mapGeom.GetGeometry();
			// simplifying geom
			com.esri.core.geometry.OperatorSimplify operatorSimplify = (com.esri.core.geometry.OperatorSimplify)com.esri.core.geometry.OperatorFactoryLocal.GetInstance().GetOperator(com.esri.core.geometry.Operator.Type.Simplify);
