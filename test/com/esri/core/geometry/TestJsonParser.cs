...
{
	public class TestJsonParser : NUnit.Framework.TestCase
	{
		...
		public virtual void Test3DPoint()
		{
			...
			com.esri.core.geometry.MapGeometry point3DMP = com.esri.core.geometry.GeometryEngine.JsonToGeometry(jsonParser3DPt);
			NUnit.Framework.Assert.IsTrue(-118.15 == ((com.esri.core.geometry.Point)point3DMP.GetGeometry()).GetX());
			NUnit.Framework.Assert.IsTrue(33.80 == ((com.esri.core.geometry.Point)point3DMP.GetGeometry()).GetY());
		...
		public virtual void TestMultiPoint()
		{
			...
			{
				org.codehaus.jackson.JsonParser mPointWgs84Parser = factory.CreateJsonParser(com.esri.core.geometry.GeometryEngine.GeometryToJson(spatialReferenceWGS84, multiPoint1));
				...
				string mPointEmptyString = com.esri.core.geometry.GeometryEngine.GeometryToJson(spatialReferenceWGS84, mPointEmpty);
		...
		public virtual void TestPolyline()
		{
			...
			polyline.LineTo(-97.06298, 32.755);
			{
				...
				string emptyString = com.esri.core.geometry.GeometryEngine.GeometryToJson(spatialReferenceWGS84, emptyPolyline);
				mPolylineWGS84MP = com.esri.core.geometry.GeometryEngine.JsonToGeometry(factory.CreateJsonParser(emptyString));
		...
		public virtual void TestPolygon()
		{
			...
			polygon.LineTo(-97.06298, 32.755);
			{
				...
				string emptyPolygonString = com.esri.core.geometry.GeometryEngine.GeometryToJson(spatialReferenceWGS84, emptyPolygon);
		...
		public virtual void TestEnvelope()
		{
			...
			envelope.SetCoords(-109.55, 25.76, -86.39, 49.94);
			{
				...
				string emptyEnvString = com.esri.core.geometry.GeometryEngine.GeometryToJson(spatialReferenceWGS84, emptyEnvelope);
		...
		public virtual void TestSpatialRef()
		{
			...
			com.esri.core.geometry.MapGeometry mapGeom = com.esri.core.geometry.GeometryEngine.JsonToGeometry(jsonParserPt);
			// showProjectedGeometryInfo(mapGeom);
			NUnit.Framework.Assert.IsTrue(mapGeom.GetSpatialReference().GetID() == 102100);
			com.esri.core.geometry.MapGeometry mapGeomOregon = com.esri.core.geometry.GeometryEngine.JsonToGeometry(jsonParseOregon);
			...
			NUnit.Framework.Assert.IsTrue(mapGeom.GetSpatialReference().GetID() == 4326);
			{
				NUnit.Framework.Assert.IsTrue(((com.esri.core.geometry.MultiPoint)mapGeom.GetGeometry()).GetPoint(0).GetX() == -97.06138);
				NUnit.Framework.Assert.IsTrue(((com.esri.core.geometry.MultiPoint)mapGeom.GetGeometry()).GetPoint(0).GetY() == 32.837);
				NUnit.Framework.Assert.IsTrue(((com.esri.core.geometry.MultiPoint)mapGeom.GetGeometry()).GetPoint(3).GetX() == -97.06127);
				NUnit.Framework.Assert.IsTrue(((com.esri.core.geometry.MultiPoint)mapGeom.GetGeometry()).GetPoint(3).GetY() == 32.832);
			}
			// showProjectedGeometryInfo(mapGeom);
			...
			mapGeom = com.esri.core.geometry.GeometryEngine.JsonToGeometry(jsonParserPl3D);
			{
				...
				NUnit.Framework.Assert.IsTrue(((com.esri.core.geometry.Polyline)mapGeom.GetGeometry()).GetPoint(0).GetX() == -97.06138);
				NUnit.Framework.Assert.IsTrue(((com.esri.core.geometry.Polyline)mapGeom.GetGeometry()).GetPoint(0).GetY() == 32.837);
				int lastIndex = ((com.esri.core.geometry.Polyline)mapGeom.GetGeometry()).GetPointCount() - 1;
				NUnit.Framework.Assert.IsTrue(((com.esri.core.geometry.Polyline)mapGeom.GetGeometry()).GetPoint(lastIndex).GetX() == -97.06298);
				// -97.06153, 32.749
				NUnit.Framework.Assert.IsTrue(((com.esri.core.geometry.Polyline)mapGeom.GetGeometry()).GetPoint(lastIndex).GetY() == 32.755);
				int lastIndexFirstLine = ((com.esri.core.geometry.Polyline)mapGeom.GetGeometry()).GetPathEnd(0) - 1;
				NUnit.Framework.Assert.IsTrue(((com.esri.core.geometry.Polyline)mapGeom.GetGeometry()).GetPoint(lastIndexFirstLine).GetX() == -97.06127);
				// -97.06153,
				// 32.749
				NUnit.Framework.Assert.IsTrue(((com.esri.core.geometry.Polyline)mapGeom.GetGeometry()).GetPoint(lastIndexFirstLine).GetY() == 32.832);
			}
			...
			{
				NUnit.Framework.Assert.IsTrue(((com.esri.core.geometry.Polygon)mapGeom.GetGeometry()).GetPoint(0).GetX() == -97.06138);
				NUnit.Framework.Assert.IsTrue(((com.esri.core.geometry.Polygon)mapGeom.GetGeometry()).GetPoint(0).GetY() == 32.837);
				int lastIndex = ((com.esri.core.geometry.Polygon)mapGeom.GetGeometry()).GetPointCount() - 1;
				NUnit.Framework.Assert.IsTrue(((com.esri.core.geometry.Polygon)mapGeom.GetGeometry()).GetPoint(lastIndex).GetX() == -97.06153);
				// -97.06153, 32.749
				NUnit.Framework.Assert.IsTrue(((com.esri.core.geometry.Polygon)mapGeom.GetGeometry()).GetPoint(lastIndex).GetY() == 32.749);
			}
		...
		public virtual void TestMP2onCR175871()
		{
			...
			pg1.LineTo(-40, 8);
			pg.Add(pg1, false);
			com.esri.core.geometry.SpatialReference spatialReference = com.esri.core.geometry.SpatialReference.Create(4326);
			try
			{
				string jSonStr = com.esri.core.geometry.GeometryEngine.GeometryToJson(spatialReference, pg);
		...
		private static void ShowProjectedGeometryInfo(com.esri.core.geometry.MapGeometry mapGeom)
		{
		...
		public virtual void TestGeometryToJSON()
		{
			...
			string outputPolygon2 = com.esri.core.geometry.GeometryEngine.GeometryToJson(4326, geom);
		...
		public virtual void TestGeometryToJSONOldID()
		{
			...
			geom.LineTo(new com.esri.core.geometry.Point(-105, 34));
			geom.LineTo(new com.esri.core.geometry.Point(-108, 40));
			string outputPolygon = com.esri.core.geometry.GeometryEngine.GeometryToJson(com.esri.core.geometry.SpatialReference.Create(3857), geom);
			// Test WKID == -1
