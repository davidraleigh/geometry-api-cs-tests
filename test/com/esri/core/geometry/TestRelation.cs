...
{
	public class TestRelation : NUnit.Framework.TestCase
	{
		...
		{
			// Tests CR 183227
			com.esri.core.geometry.OperatorTouches operatorTouches = (com.esri.core.geometry.OperatorTouches)(com.esri.core.geometry.OperatorFactoryLocal.GetInstance().GetOperator(com.esri.core.geometry.Operator.Type.Touches));
		...
		public virtual void TestPolylineMultiPointTouches()
		{
			...
			polyline1.LineTo(1, 0);
			polyline1.LineTo(1, 1);
			touches.AccelerateGeometry(polyline1, sr, com.esri.core.geometry.Geometry.GeometryAccelerationDegree.enumHot);
		...
		public virtual void TestPolylineMultiPointCrosses()
		{
			...
			res = crosses.Execute(multipoint2, polyline1, sr, null);
			NUnit.Framework.Assert.IsTrue(!res);
			crosses.AccelerateGeometry(polyline1, sr, com.esri.core.geometry.Geometry.GeometryAccelerationDegree.enumHot);
			multipoint2.Add(1, 0);
			res = crosses.Execute(polyline1, multipoint2, sr, null);
			NUnit.Framework.Assert.IsTrue(res);
			res = crosses.Execute(multipoint2, polyline1, sr, null);
		...
		public virtual void TestCrosses_github_issue_40()
		{
			...
			com.esri.core.geometry.Geometry geom1 = com.esri.core.geometry.OperatorImportFromWkt.Local().Execute(0, com.esri.core.geometry.Geometry.Type.Unknown, "LINESTRING (2 0, 2 3)", null);
			com.esri.core.geometry.Geometry geom2 = com.esri.core.geometry.OperatorImportFromWkt.Local().Execute(0, com.esri.core.geometry.Geometry.Type.Unknown, "POLYGON ((1 1, 4 1, 4 4, 1 4, 1 1))", null);
			bool answer1 = com.esri.core.geometry.OperatorCrosses.Local().Execute(geom1, geom2, null, null);
			NUnit.Framework.Assert.IsTrue(answer1);
			com.esri.core.geometry.OperatorCrosses.Local().AccelerateGeometry(geom1, null, com.esri.core.geometry.Geometry.GeometryAccelerationDegree.enumHot);
			bool answer2 = com.esri.core.geometry.OperatorCrosses.Local().Execute(geom1, geom2, null, null);
