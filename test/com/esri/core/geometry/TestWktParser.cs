...
{
	public class TestWktParser : NUnit.Framework.TestCase
	{
		...
		public virtual void TestMultiLineString()
		{
			...
			double value;
			currentToken = wktParser.NextToken();
			NUnit.Framework.Assert.IsTrue(currentToken == com.esri.core.geometry.WktParser.WktToken.multilinestring);
			currentToken = wktParser.NextToken();
			NUnit.Framework.Assert.IsTrue(currentToken == com.esri.core.geometry.WktParser.WktToken.empty);
			...
			NUnit.Framework.Assert.IsTrue(currentToken == com.esri.core.geometry.WktParser.WktToken.multilinestring);
			currentToken = wktParser.NextToken();
			NUnit.Framework.Assert.IsTrue(currentToken == com.esri.core.geometry.WktParser.WktToken.attribute_z);
			currentToken = wktParser.NextToken();
			NUnit.Framework.Assert.IsTrue(currentToken == com.esri.core.geometry.WktParser.WktToken.left_paren);
			currentToken = wktParser.NextToken();
			NUnit.Framework.Assert.IsTrue(currentToken == com.esri.core.geometry.WktParser.WktToken.empty);
		...
		public virtual void TestMultiPoint()
		{
			...
			double value;
			currentToken = wktParser.NextToken();
			NUnit.Framework.Assert.IsTrue(currentToken == com.esri.core.geometry.WktParser.WktToken.multipoint);
			currentToken = wktParser.NextToken();
			NUnit.Framework.Assert.IsTrue(currentToken == com.esri.core.geometry.WktParser.WktToken.empty);
