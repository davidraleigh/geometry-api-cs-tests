...
{
	public class TestConvexHull : NUnit.Framework.TestCase
	{
		...
		public static void TestSquare()
		{
			com.esri.core.geometry.OperatorConvexHull bounding = (com.esri.core.geometry.OperatorConvexHull)com.esri.core.geometry.OperatorFactoryLocal.GetInstance().GetOperator(com.esri.core.geometry.Operator.Type.ConvexHull);
			com.esri.core.geometry.OperatorDensifyByLength densify = (com.esri.core.geometry.OperatorDensifyByLength)com.esri.core.geometry.OperatorFactoryLocal.GetInstance().GetOperator(com.esri.core.geometry.Operator.Type.DensifyByLength);
			com.esri.core.geometry.OperatorDifference difference = (com.esri.core.geometry.OperatorDifference)com.esri.core.geometry.OperatorFactoryLocal.GetInstance().GetOperator(com.esri.core.geometry.Operator.Type.Difference);
			...
			square.LineTo(3, 0);
			square.LineTo(2, 1);
			com.esri.core.geometry.Polygon densified = (com.esri.core.geometry.Polygon)(densify.Execute(square, 1.0, null));
			com.esri.core.geometry.Polygon convex_hull = (com.esri.core.geometry.Polygon)(bounding.Execute(densified, null));
			com.esri.core.geometry.Polygon differenced = (com.esri.core.geometry.Polygon)(difference.Execute(densified, convex_hull, com.esri.core.geometry.SpatialReference.Create(4326), null));
		...
		public static void TestPolygons()
		{
			...
			{
				com.esri.core.geometry.Polygon polygon = (com.esri.core.geometry.Polygon)(com.esri.core.geometry.TestCommonMethods.FromJson("{\"rings\":[[[28.865673900286581,33.379551302126075],[39.505669183485338,-34.957993133630559],[7.152466542048213,-90],[28.865673900286581,33.379551302126075]],[[-64.597291313620858,2.4515644574812248],[20.050002923927103,90],[24.375150856531356,62.220853377417541],[-64.597291313620858,2.4515644574812248]],[[28.865673900286581,33.379551302126075],[24.375150856531356,62.220853377417541],[35.223952527956932,69.508785974507163],[28.865673900286581,33.379551302126075]]]}"
					).GetGeometry());
				com.esri.core.geometry.Polygon convex_hull = (com.esri.core.geometry.Polygon)(bounding.Execute(polygon, null));
				com.esri.core.geometry.Polygon differenced = (com.esri.core.geometry.Polygon)(difference.Execute(polygon, convex_hull, com.esri.core.geometry.SpatialReference.Create(4326), null));
				NUnit.Framework.Assert.IsTrue(differenced.IsEmpty());
			...
			{
				com.esri.core.geometry.Polygon polygon = (com.esri.core.geometry.Polygon)(com.esri.core.geometry.TestCommonMethods.FromJson("{\"rings\":[[[-66.582505384413167,-51.305212522944061],[-60.169897093348865,-90],[-90,-90],[-66.582505384413167,-51.305212522944061]],[[20.858462934004656,-90],[-35.056287147954386,0.78833269359179781],[18.933251883215579,90],[20.858462934004656,-90]],[[-66.582505384413167,-51.305212522944061],[-90,90],[-35.056287147954386,0.78833269359179781],[-66.582505384413167,-51.305212522944061]]]}"
					).GetGeometry());
				com.esri.core.geometry.Polygon convex_hull = (com.esri.core.geometry.Polygon)(bounding.Execute(polygon, null));
				com.esri.core.geometry.Polygon differenced = (com.esri.core.geometry.Polygon)(difference.Execute(polygon, convex_hull, com.esri.core.geometry.SpatialReference.Create(4326), null));
				NUnit.Framework.Assert.IsTrue(differenced.IsEmpty());
			...
			{
				com.esri.core.geometry.Polygon polygon = (com.esri.core.geometry.Polygon)(com.esri.core.geometry.TestCommonMethods.FromJson("{\"rings\":[[[36.692916710279974,-90],[-31.182443792600079,6.434474852744998],[-90,90],[52.245260790065387,57.329280208760991],[36.692916710279974,-90]]]}").GetGeometry());
				com.esri.core.geometry.Polygon convex_hull = (com.esri.core.geometry.Polygon)(bounding.Execute(polygon, null));
				com.esri.core.geometry.Polygon differenced = (com.esri.core.geometry.Polygon)(difference.Execute(polygon, convex_hull, com.esri.core.geometry.SpatialReference.Create(4326), null));
				NUnit.Framework.Assert.IsTrue(differenced.IsEmpty());
				NUnit.Framework.Assert.IsTrue(bounding.IsConvex(convex_hull, null));
			...
			{
				com.esri.core.geometry.Polygon polygon = (com.esri.core.geometry.Polygon)(com.esri.core.geometry.TestCommonMethods.FromJson("{\"rings\":[[[17.198360589495572,-77.168667157542373],[-24.835678541343281,-83.717338556412017],[-30.259244993378722,61.914816728303791],[17.198360589495572,-77.168667157542373]],[[-8.3544985146710644,-90],[17.979891823366039,-79.459092168186686],[21.576625471325329,-90],[-8.3544985146710644,-90]],[[17.979891823366039,-79.459092168186686],[17.198360589495572,-77.168667157542373],[27.846596597209441,-75.509730732825361],[17.979891823366039,-79.459092168186686]]]}"
					).GetGeometry());
				com.esri.core.geometry.Polygon convex_hull = (com.esri.core.geometry.Polygon)(bounding.Execute(polygon, null));
				com.esri.core.geometry.Polygon differenced = (com.esri.core.geometry.Polygon)(difference.Execute(polygon, convex_hull, com.esri.core.geometry.SpatialReference.Create(4326), null));
				NUnit.Framework.Assert.IsTrue(differenced.IsEmpty());
		...
		public static void TestPolylines()
		{
			...
			com.esri.core.geometry.OperatorContains contains = (com.esri.core.geometry.OperatorContains)com.esri.core.geometry.OperatorFactoryLocal.GetInstance().GetOperator(com.esri.core.geometry.Operator.Type.Contains);
			{
				...
				poly.LineTo(0, 40);
				poly.LineTo(0, 500);
				com.esri.core.geometry.Polyline densified = (com.esri.core.geometry.Polyline)(densify.Execute(poly, 10.0, null));
				com.esri.core.geometry.Polygon convex_hull = (com.esri.core.geometry.Polygon)(bounding.Execute(densified, null));
				com.esri.core.geometry.Polyline differenced = (com.esri.core.geometry.Polyline)(difference.Execute(densified, convex_hull, com.esri.core.geometry.SpatialReference.Create(4326), null));
				NUnit.Framework.Assert.IsTrue(differenced.IsEmpty());
				NUnit.Framework.Assert.IsTrue(bounding.IsConvex(convex_hull, null));
			}
			{
				...
				com.esri.core.geometry.Polyline densified = (com.esri.core.geometry.Polyline)(densify.Execute(polyline, 10.0, null));
				com.esri.core.geometry.Polygon convex_hull = (com.esri.core.geometry.Polygon)(bounding.Execute(densified, null));
				bool bcontains = contains.Execute(convex_hull, densified, com.esri.core.geometry.SpatialReference.Create(4326), null);
