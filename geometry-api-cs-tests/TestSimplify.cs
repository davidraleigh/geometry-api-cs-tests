	...
	public class TestSimplify : NUnit.Framework.TestFixtureAttribute
	{
		...
		*/
		...
		public virtual void Test0PolygonSelfIntersect3()
		{
			...
			NUnit.Framework.Assert.IsTrue(!res);
			com.esri.core.geometry.Polygon poly2 = (com.esri.core.geometry.Polygon)simplifyOp.Execute(poly, null, false, null);
			res = simplifyOp.IsSimpleAsFeature(poly2, null, true, null, null);
			NUnit.Framework.Assert.IsTrue(res);
			NUnit.Framework.Assert.IsTrue(!poly2.IsEmpty());
		}
		...
		[NUnit.Framework.Test]
		public virtual void TestIsSimpleAsFeatureTrue() {
			com.esri.core.geometry.Polygon poly = new com.esri.core.geometry.Polygon();
			poly.StartPath(0, 0);
			poly.LineTo(0, 15);
			poly.LineTo(15, 15);
			poly.LineTo(15, 0);
			bool res = simplifyOp.IsSimpleAsFeature(poly, sr3857, true, null, null);
			NUnit.Framework.Assert.IsTrue(res);
			...
			res = simplifyOp.IsSimpleAsFeature(poly, sr3857, true, null, null);
			NUnit.Framework.Assert.IsTrue(res);
		}

		[NUnit.Framework.Test]
		public virtual void TestIsSimpleAsFeatureFalse() {
			com.esri.core.geometry.Polygon nonSimplePolygon = new com.esri.core.geometry.Polygon();
			nonSimplePolygon.StartPath(0, 0);
			nonSimplePolygon.LineTo(0, 15);
			nonSimplePolygon.LineTo(15, 15);
			nonSimplePolygon.LineTo(15, 0);
			bool res = simplifyOp.IsSimpleAsFeature(nonSimplePolygon, sr3857, true, null, null);
			NUnit.Framework.Assert.IsTrue(res);

						// This is an interior ring but it is clockwise
			nonSimplePolygon.StartPath(5, 5);
			nonSimplePolygon.LineTo(5, 6);
			nonSimplePolygon.LineTo(6, 6);
			nonSimplePolygon.LineTo(6, 5);
			res = simplifyOp.IsSimpleAsFeature(nonSimplePolygon, sr3857, true, null, null);
			NUnit.Framework.Assert.IsFalse(res);
			com.esri.core.geometry.Polygon simplePolygon = (com.esri.core.geometry.Polygon)simplifyOp.Execute(nonSimplePolygon, sr3857, false, null);
			res = simplifyOp.IsSimpleAsFeature(simplePolygon, sr3857, true, null, null);
			NUnit.Framework.Assert.IsFalse(res);

			com.esri.core.geometry.Polygon nonSimplePolygon2 = new com.esri.core.geometry.Polygon();
			nonSimplePolygon2.StartPath(0, 0);
			nonSimplePolygon2.LineTo(0, 15);
			nonSimplePolygon2.LineTo(15, 15);
			nonSimplePolygon2.LineTo(15, 0);

			// This part intersects with the first part
			nonSimplePolygon2.StartPath(10, 10);
			nonSimplePolygon2.LineTo(10, 20);
			nonSimplePolygon2.LineTo(20, 20);
			nonSimplePolygon2.LineTo(20, 10);
			res = simplifyOp.IsSimpleAsFeature(nonSimplePolygon2, sr3857, true, null, null);
			NUnit.Framework.Assert.IsFalse(res);
			com.esri.core.geometry.Polygon simplePolygon2 = (com.esri.core.geometry.Polygon)simplifyOp.Execute(nonSimplePolygon2, sr3857, false, null);
			res = simplifyOp.IsSimpleAsFeature(simplePolygon2, sr3857, true, null, null);
			NUnit.Framework.Assert.IsFalse(res);
		}
		...
		public virtual void TestPolygon3()
		{
			...
			com.esri.core.geometry.Polygon simplePolygon3 = (com.esri.core.geometry.Polygon)simplifyOp.Execute(nonSimplePolygon3, sr3857, false, null);
		...
		public virtual void TestPolyline()
		{
			...
			com.esri.core.geometry.Polyline simplePolyline = (com.esri.core.geometry.Polyline)simplifyOp.Execute(nonSimplePolyline, sr3857, false, null);
		...
		public virtual void TestPolygon4()
		{
			...
			com.esri.core.geometry.Polygon simplePolygon4 = (com.esri.core.geometry.Polygon)simplifyOp.Execute(nonSimplePolygon4, sr3857, false, null);
		...
		public virtual void TestPolygon5()
		{
			...
			com.esri.core.geometry.Polygon simplePolygon5 = (com.esri.core.geometry.Polygon)simplifyOp.Execute(nonSimplePolygon5, sr3857, false, null);
		...
		public virtual void TestPolygon6()
		{
			...
			com.esri.core.geometry.Polygon simplePolygon6 = (com.esri.core.geometry.Polygon)simplifyOp.Execute(nonSimplePolygon6, sr3857, false, null);
		...
		public virtual void TestPolygon7()
		{
			...
			com.esri.core.geometry.Polygon simplePolygon7 = (com.esri.core.geometry.Polygon)simplifyOp.Execute(nonSimplePolygon7, sr3857, false, null);
